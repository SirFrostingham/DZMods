modded class PlayerBase
{
	...
	override void OnConnect()
    {
        ...
        ref SurvivorBase ChachedSB;
		ChachedSB = SurvivorBase.Cast(this);
		...
		if ( !FileExist(KillLogFileLocation) ) 
		{
			...
			FPrintln(KillLogs,"          -------------- KILL ACTIVITY LOGS --------------"); //Print Start Line
    ...
    override void EEKilled( Object killer )
    {
		...
		FileHandle KillLogs;
		string TimeStamp;
        ref SurvivorBase SurvivorKilled;
		SurvivorKilled = SurvivorBase.Cast(this);
        ref SurvivorBase SurvivorKiller;
		SurvivorKiller = SurvivorBase.Cast(killer);
		if(SurvivorKiller != NULL)
		{
			ref Man KillerDude;
			KillerDude = Man.Cast(killer);
	...
	override void EEHitBy(TotalDamageResult damageResult, int damageType, EntityAI source, int component, string dmgZone, string ammo, vector modelPos)
	{
		...
		SBPlayer = SurvivorBase.Cast(this);
